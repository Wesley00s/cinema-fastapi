const loadSessions = async () => {
    try {
        ...
        for (const session of sessions) {
            ...
            sessionCard.className = 'bg-stone-900 flex w-auto rounded-xl p-6 shadow-xl transition duration-300 mb-6';
            ...
            sessionCard.innerHTML = `
                ...
                minute: '2-digit'
                        ...
                        <div class="flex flex-col flex-row items-center justify-between gap-4 pt-4 border-t border-stone-800">
